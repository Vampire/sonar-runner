...
public class CliTest {
  ...
  public void should_enable_debug_mode() {
    ...
    assertThat(cli.properties().get("sonar.log.level")).isEqualTo("DEBUG");
  }
  ...
  public void should_enable_stacktrace_log() {
    ...
    assertThat(cli.isDebugMode()).isFalse();
    assertThat(cli.isDisplayStackTrace()).isTrue();
    assertThat(cli.properties().get("sonar.log.level")).isNull();
  }
  ...
  public void should_set_log_level() {
    ...
    assertThat(cli.isDebugMode()).isFalse();
    assertThat(cli.isDisplayStackTrace()).isFalse();
    assertThat(cli.properties().get("sonar.log.level")).isEqualTo("WARN");
  }
